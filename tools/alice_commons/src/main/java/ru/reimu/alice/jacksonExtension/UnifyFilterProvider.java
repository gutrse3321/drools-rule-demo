...
public class UnifyFilterProvider extends FilterProvider implements Serializable {
    ...
    public ru.reimu.alice.jacksonExtension.UnifyFilterProvider setFailOnUnknownId(boolean state) {
    ...
    public ru.reimu.alice.jacksonExtension.UnifyFilterProvider addFilter(String id, PropertyFilter filter) {
        _filtersById.put(id, filter);
        return this;
    }

    public ru.reimu.alice.jacksonExtension.UnifyFilterProvider addFilter(Class<?> id, PropertyFilter filter) {
        _filtersByClass.put(id, filter);
        return this;
    }

    public ru.reimu.alice.jacksonExtension.UnifyFilterProvider addFilter(String id, SimpleBeanPropertyFilter filter) {
        _filtersById.put(id, filter);
        return this;
    }

    public ru.reimu.alice.jacksonExtension.UnifyFilterProvider addFilter(Class<?> id, SimpleBeanPropertyFilter filter) {
        _filtersByClass.put(id, filter);
        return this;
    }

    public ru.reimu.alice.jacksonExtension.UnifyFilterProvider setDefaultFilter(PropertyFilter f) {
        _defaultFilter = f;
        return this;
    }
