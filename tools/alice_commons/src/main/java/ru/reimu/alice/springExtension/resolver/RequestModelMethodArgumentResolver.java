...
import ru.reimu.alice.springExtension.resolver.annotation.MapWapper;
import ru.reimu.alice.springExtension.resolver.annotation.RequestModel;
...
public class RequestModelMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter methodParameter) {
        if (methodParameter.hasParameterAnnotation(RequestModel.class)) {
            return true;
        }
        return false;
    }
